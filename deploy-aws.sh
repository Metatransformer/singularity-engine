...
deploy_lambda "$WATCHER_FN" "aws/tweet-watcher/index.mjs" "true" "$TMPDIR_WATCHER/package.json" \
  "TABLE_NAME=$TABLE_NAME,CODE_RUNNER_FUNCTION=$CODE_RUNNER_FN,DEPLOYER_FUNCTION=$DEPLOYER_FN,X_BEARER_TOKEN=${X_BEARER_TOKEN:-},WATCHED_TWEET_ID=${WATCHED_TWEET_ID:-},OWNER_USERNAME=${OWNER_USERNAME:-},EXTRA_BOT_USERNAMES=${EXTRA_BOT_USERNAMES:-singularityengn}" 300 256
